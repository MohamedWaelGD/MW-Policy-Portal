      ...
      <div className="flex-1 flex flex-col relative overflow-hidden">
        ...
        <header className="h-16 border-b border-white/5 bg-[#050505]/80 backdrop-blur-md flex items-center justify-between px-6 md:px-8 z-10 sticky top-0">
          ...
          <div className="flex items-center gap-6">
             ...
             <div className="flex items-center gap-2 cursor-pointer hover:bg-white/5 p-1 rounded-lg transition-colors pr-2">
                <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-zinc-700 to-zinc-600 border border-white/10 flex items-center justify-center text-xs font-bold text-white">
                  JD
                </div>
